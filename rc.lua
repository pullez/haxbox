...
beautiful.init("/usr/share/awesome/themes/default/theme1.lua")
...
tags = {
   names  = { "explorer", "web", "skype", "torrent", "media", "dropbox", "steam", "mail", "v-box/remote desktop" },
   layout = { layouts[1], layouts[1], layouts[2], layouts[2], layouts[2],
              layouts[2], layouts[1], layouts[2], layouts[1]
 }}
 for s = 1, screen.count() do
...
myawesomemenu = {
   { "edit config", terminal.. "sudo gedit /home/patz/.config/awesome/rc.lua" },
   { "edit theme", terminal.. "sudo gedit /usr/share/awesome/themes/default/theme1.lua" },
   { "power off", poweroff },
...
mywebmenu = {
   ...
   {" Transmission",         "transmission-qt", beautiful.qbittorrent_icon},
...
awful.util.spawn_with_shell("transmission-qt")
